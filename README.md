...
1. En el archivo `config.json` ubicado en el directorio _root_ del proyecto, modifique las variables `folder1`, `folder2` y `resultsFolder`, de acuerdo con las siguiente descriciones:
  - folder1: directori donde se encuentran las capturas de pantalla de la versión de la aplicación de referencia (para nuestro caso la versión v4.41.3)
